...
function calcButtonClick(){
    var x = document.getElementById("amountOwed");
    ...
    if (random ==0){
        x.display("You owe " + random; "cat tax! You've escaped this time!")
    }
